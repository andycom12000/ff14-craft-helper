    ...
    <template v-if="!isMobile">
      ...
      <div class="b-page-grid">
        ...
        <section class="b-main">
          <template v-if="canSimulate">
            ...
            <template v-if="isTwoCol">
              ...
              <section class="cockpit-section cockpit-section--hq">
                <header class="cockpit-section-head">
                  <span class="cockpit-section-label">熔接顧問</span>
                </header>
        ...
        <aside v-if="!isTwoCol" class="rail rail-right">
          ...
          <section class="rail-section">
            <header class="rail-section-head">
              <span class="rail-section-label">熔接顧問</span>
            </header>
            <MeldAdvisorCard :advice="meldAdvice" />
          </section>
        </aside>
...
/* 1100–1360: shrink rail, give b-main a 2-col grid so HQ panels sit
 * beside cockpit-body instead of forcing a long scroll. Below 1100 each
 * side would be too narrow for the HQ row controls. */
...
/* 1361–1720: unwrap cockpit-body via display:contents so tool, sequence-col,
 * and HQ panels participate in a single b-main grid — HQ slots below tool
 * in col 1 instead of forming a wide band below an already-tall sequence-col. */
@media (min-width: 1361px) and (max-width: 1720px) {
  ...
  /* display:contents drops the .cockpit-body box, so .is-blocked's
   * pointer-events no longer anchors — propagate to children. */
...
[data-theme="dark"] .gearset-banner.is-soft .gearset-banner-title { color: oklch(0.82 0.10 75); }
[data-theme="dark"] .gearset-banner.is-soft .gearset-banner-desc { color: oklch(0.72 0.09 75); }
