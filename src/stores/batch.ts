...
// existing `import type { ... } from '@/stores/batch'` call sites keep working.
// The result-type definitions themselves live in `./batch.types` to keep this
// file focused on state + actions.
