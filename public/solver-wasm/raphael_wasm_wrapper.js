/* @ts-self-types="./raphael_wasm_wrapper.d.ts" */
 ...
 * @returns {Promise<any>}
 */
export function init_threads(num_threads) {
    const ret = wasm.init_threads(num_threads);
    return ret;
}
 ...
 * @returns {any}
 */
export function simulate(config_js) {
    const ret = wasm.simulate(config_js);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function simulate_detail(config_js) {
    const ret = wasm.simulate_detail(config_js);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports(memory) {
    ...
    return {
        __proto__: null,
        "./raphael_wasm_wrapper_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('raphael_wasm_wrapper_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
